<footer>
    <div class="bg-primary-dark inner-box">
        <div class="container">
            <div class="row">
                <div class="col-md-4">
                    <a href="<?php echo BASE_PATH; ?>" class="navbar-brand  d-flex align-items-center">
                        <img src="<?php echo $this->logo; ?>" alt="logo">
                    </a>
                    <p class="mb-4 mt-2"><?php echo strip_tags(htmlspecialchars_decode($this->config->biz_description)); ?> </p>
                    <div class="d-flex align-items-center pt-2 mb-3">
                        <p class="mb-0 text-white">
                            <i class="ri ri-mail-line ri-mr"></i> <?php echo $this->contact_email; ?>
                        </p>
                    </div>
                    <div class="d-flex align-items-center">
                        <p class="mb-0 text-white">
                            <i class="ri ri-phone-line ri-mr"></i> <?php echo $this->contact_number; ?>
                        </p>
                    </div>
                </div>
                <div class="col-md-2 mt-md-0 mt-4">
                    <h5 class="mb-4 text-white">Customer Service</h5>
        ...
        <div class="container py-4 footer-border">
            <div class="row">
                <div class="col-md-12 text-center text-white">
                    <p class="mb-0">Copyright © <?php echo date('Y', time()) . ' ' . $this->site_name; ?>.
                        Powered by <a href="https://smb.ng" target="_blank" class="text-white">SmartBizness Integrated
                            Solutions</a>
                    </p>
                </div>
            </div>
...
<input type="hidden" value="<?php echo (int)$this->min_price; ?>" id="min-sale-price">
<input type="hidden" value="<?php echo (int)$this->max_price; ?>" id="max-sale-price">
<input type="hidden" value="<?php echo BASE_PATH; ?>" id="base_path">
