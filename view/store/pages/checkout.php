                        ...
                        <div class="table-responsive">
                            <table class="table table-responsive mb-0">
                                ...
                                <tr data-item="list">
                                    <td scope="row">
                                        <div class="d-flex align-items-center gap-4">
                                            <img src="../e-commerce/assets/images/cart/01.png" alt="image"
                                                 class="img-fluid object-contain avatar-100 iq-product-bg p-3"
                                                 loading="lazy">
                                            <div>
                                ...
                                <tr data-item="list">
                                    <td scope="row">
                                        <div class="d-flex align-items-center gap-4">
                                            <img src="../e-commerce/assets/images/cart/02.png" alt="image"
                                                 class="img-fluid object-contain avatar-100 iq-product-bg p-3"
                                                 loading="lazy">
                                            <div>
                                ...
                                <tr data-item="list">
                                    <td scope="row">
                                        <div class="d-flex align-items-center gap-4">
                                            <img src="../e-commerce/assets/images/cart/03.png" alt="image"
                                                 class="img-fluid object-contain avatar-100 iq-product-bg p-3"
                                                 loading="lazy">
                                            <div>
                                ...
                                <tr data-item="list">
                                    <td scope="row">
                                        <div class="d-flex align-items-center gap-4">
                                            <img src="../e-commerce/assets/images/product/02.png" alt="image"
                                                 class="img-fluid object-contain avatar-100 iq-product-bg p-3"
                                                 loading="lazy">
                                            <div>
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="mt-4">
                            ...
                            <div class="d-flex">
                                <a id="place-order" href="#payment"
                                   class="btn btn-primary d-block mt-3 w-100">Checkout</a>
                            </div>
                        </div>
                    </div>
                </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-12">
                                    <div class="form-group mb-0">
                                        ...
                                        <textarea class="form-control" rows="4" id="Comment" placeholder=""
                                ...
                                <div class="col-lg-12 d-flex my-4">
                                    <div class="form-check">
                                        ...
                                        <label class="form-check-label" for="Daddress">Make this my default
                                            address.</label>
                                    </div>
                                </div>
                                <div class="d-flex">
                        ...
                        <div class="border-bottom">
                            <div class="d-flex justify-content-between align-items-center mb-3">
                                <div class="d-flex align-items-center">
                                    <svg width="20" class="text-primary" viewBox="0 0 20 20" fill="none"
                                         xmlns="http://www.w3.org/2000/svg">
                                        ...
                                        <path d="M9.99512 6.20312V10.6221" stroke="currentColor" stroke-width="1.5"
                                              stroke-linecap="round" stroke-linejoin="round"></path>
                                        <path d="M9.995 13.7969H10.005" stroke="currentColor" stroke-width="2"
                                              stroke-linecap="round" stroke-linejoin="round"></path>
                                    </svg>
                                    <h6 class="mb-0 ms-2">
                                        New user?
                        ...
                        <div class="mt-4">
                            ...
                            <div class="d-flex justify-content-between flex-wrap">
                                <a id="backbutton" href="#checkout"
                                   class="btn btn-primary-subtle d-block back justify-content-between">Back</a>
                    ...
                    <div class="card-body">
                        <div class="d-flex justify-content-between flex-wrap">
                            <div class="d-flex mt-3 gap-3">
                                <img class="img-fluid" src="../e-commerce/assets/images/user-cards/02.png" alt="01"
                                     loading="lazy">
                        ...
                        <div class="card-lists">
                            <div class="form-group mt-4">
                                <div class="form-check mb-4">
                                    <input type="radio" id="credit" name="customRadio" class="form-check-input"
                                           checked="">
